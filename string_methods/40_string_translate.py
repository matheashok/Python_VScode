...
# Parameter Values
# table : Required. Either a dictionary, or a mapping table describing how to perform 
#                                                                       the replace
...
# The third parameter in the mapping table describes characters that you want to 
