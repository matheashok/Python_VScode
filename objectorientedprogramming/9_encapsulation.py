...
# Private Properties: In Python, you can make properties private by using a double underscore __ prefix:
...
# Note: A single underscore _ is just a convention. It tells other programmers that the property is
#                            intended for internal use, but Python doesn't enforce this restriction.
...
# Note: Just like private properties with double underscores, private methods cannot be called directly 
#      from outside the class. The __validate method can only be used by other methods inside the class.
