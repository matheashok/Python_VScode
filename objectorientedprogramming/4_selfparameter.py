...
# Note: While you can use a different name, it is strongly recommended to use self as it is the 
#                              convention in Python and makes your code more readable to others.
...
'''class Person:
  ...
  def welcome(self):
    message = self.greet()
    print(message + "! Welcome to our place.")
