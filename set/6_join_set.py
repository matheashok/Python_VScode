...
# Example : Join sets that contains the values True, False, 1, and 0, and see what is considered 
#                                                                                  as duplicates:
...
# Example
# Use the difference_update() method to keep only the items from the first set that are not present
#                                                                                  in the other set:
...
# Example : Use the symmetric_difference_update() method to keep the items that are not present in 
#                                                                                        both sets:
