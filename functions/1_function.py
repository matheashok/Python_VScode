...
# A Function names are case-sensitive (myFunction and myfunction are different)
...
# Example: With functions - reusable code:
...
# The pass statement is often used when developing, allowing you to define the structure first and 
#                                                                          implement details later.