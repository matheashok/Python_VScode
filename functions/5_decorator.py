...
# By placing @changecase directly above the function definition, the function myfunction is being
#                                                        "decorated" with the changecase function.
# The function changecase is the decorator.
# The function myfunction is the function that gets decorated.

# Multiple Decorator Calls
# A decorator can be called multiple times. Just place the decorator above the function you want to 
#                                                                                          decorate.
...
# Functions that require arguments can also be decorated, just make sure you pass the arguments to 
...
# Example: A decorator factory that takes an argument and transforms the casing based on the argument 
#                                                                                               value.
