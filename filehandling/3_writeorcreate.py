...
# Example: Open the file "demofile1.txt" and append content to the file:

'''with open("demofile1.txt", "a") as f:
  f.write("Now the file has more new content!")'''
...
# Example: Open the file "demofile1.txt" and overwrite the content:
